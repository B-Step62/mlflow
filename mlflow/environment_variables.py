...
#: model serving endpoint. If true, the trace will be written to both the MLflow
#: Backend and the Inference Table.
_ENABLE_TRACE_DUAL_WRITE_IN_DB_MODEL_SERVING = _EnvironmentVariable(
    "ENABLE_TRACE_DUAL_WRITE_IN_DB_MODEL_SERVING", bool, False
)
