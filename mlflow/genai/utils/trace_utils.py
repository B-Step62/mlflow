...
def copy_model_serving_trace_to_eval_run(trace_dict: dict[str, Any], experiment_id: str) -> str:
    ...
    # Generate request/response preview again because it might not be set in
    # some cases e.g. trace is in V2 schema.
    set_request_response_preview(new_trace_info, new_trace.data)
