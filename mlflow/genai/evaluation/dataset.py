# TODO: We don't need most of columns defined in this file.
...
class _GuidelinesCol(_InputColumn):
    ...
    def validate(cls, df: pd.DataFrame):
        ...
        for index, value in df[cls.name].items():
            ...
            is_valid_iterable = is_valid_guidelines_iterable(value)
            is_valid_mapping = is_valid_guidelines_mapping(value)
...
class EvaluationDataframe:
    ...
    def eval_items(self) -> List[entities.EvalItem]:
        ...
        return [
            ...
            entities.EvalItem.from_dict(convert_ndarray_to_list(row))
