...
from mlflow.genai.evaluation import schemas, entities
from mlflow.genai.evaluation.agent_utils import _AGGREGATION_TO_AGGREGATE_FUNCTION, ValidationError
...
# TODO: Deprecate this class in favor of CustomScorer
...
def metric(
    ...
    *,
    ...
    def decorator(fn, *, _name=name, _aggregations=aggregations):
        ...
        supported_aggregations = list(_AGGREGATION_TO_AGGREGATE_FUNCTION.keys())
