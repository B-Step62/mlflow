...
export const TimelineTreeHeader = ({
  ...
  const copiedNotificationTimerIdRef = useRef<number>();

  useEffect(() => {
    return () => {
      window.clearTimeout(copiedNotificationTimerIdRef.current);
    };
  }, []);
  ...
  const handleCopyTraceId = async () => {
    ...
    if (success) {
      ...
      copiedNotificationTimerIdRef.current = window.setTimeout(() => {
    ...
    <>
      ...
      {showCopiedNotification && (
        <Notification.Provider>
          <Notification.Root severity="success" componentId="shared.model-trace-explorer.trace-id-copy-notification">
            <Notification.Title>
              <FormattedMessage
                defaultMessage="Copied to clipboard"
                description="Success message after copying the trace ID"
              />
            </Notification.Title>
          </Notification.Root>
