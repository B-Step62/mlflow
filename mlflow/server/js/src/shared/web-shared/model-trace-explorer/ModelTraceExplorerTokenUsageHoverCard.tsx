      ...
      content={
        ...
        >
          ...
          >
            ...
            {tokenUsage.cache_read_input_tokens != null && tokenUsage.cache_read_input_tokens > 0 && (
              <div
                css={{
                  display: 'flex',
                  flexDirection: 'row',
              ...
              >
                ...
                <Tag componentId="shared.model-trace-explorer.token-usage-hovercard.cache-read-tokens.tag">
