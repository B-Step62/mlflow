    ...
    <StackedComponents
      first={
        <TokenComponent
          ...
          cacheReadInputTokens={currentTokenUsage?.cache_read_input_tokens}
      ...
      second={
        isComparing && (
          <TokenComponent
            ...
            cacheReadInputTokens={otherTokenUsage?.cache_read_input_tokens}
              ...
              >
                <Typography.Text>
                  {intl.formatMessage({
                    ...
                    description: 'Label for the cache read tokens in the tooltip for the tokens cell.',
                  })}
                </Typography.Text>
              </div>
              <div>
                <Typography.Text color="secondary">{cacheReadInputTokens}</Typography.Text>
              </div>
            </div>
          )}
          {cacheCreationInputTokens != null && cacheCreationInputTokens > 0 && (
            ...
            >
              ...
              >
                <Typography.Text>
                  {intl.formatMessage({
                    defaultMessage: 'Cache creation',
                    description:
                      'Label for the cache creation tokens in the tooltip for the tokens cell.',
                  })}
                </Typography.Text>
              </div>
              <div>
