...
class Span:
    ...
    def request_id(self) -> str:
        """Deprecated. Please use `trace_id` instead."""
    ...
    def from_dict(cls, data: dict[str, Any]) -> "Span":
        ...
        try:
            ...
            trace_id = attributes.get(SpanAttributeKey.REQUEST_ID)
            if not trace_id:
                raise MlflowException(
    ...
    def from_immutable_span(
        ...
        Args:
            ...
            otel_trace_id: The OpenTelemetry trace ID of the new span in hex encoded format.
                Specify this if you want to create the new span with a different Otel trace ID
