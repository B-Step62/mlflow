...
from mlflow.openai.constants import FLAVOR_NAME, OPENAI_VERSION
...
def _get_model_name(model):
    ...
    if Version(OPENAI_VERSION).major < 1 and isinstance(model, openai.Model):
        return model.id
...
def save_model(
    ...
    **kwargs,
    ...
    """
    if Version(OPENAI_VERSION).major < 1:
