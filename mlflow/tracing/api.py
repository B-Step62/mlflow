...
from mlflow.tracing.constant import SEARCH_TRACES_DEFAULT_MAX_RESULTS, SpanAttributeKey
...
def trace(
    ...
    """
    from mlflow.tracing.utils._wrapper import wrap_function, wrap_generator
...
def get_trace(request_id: str) -> Optional[Trace]:
    ...
    try:
        return TracingClient().get_trace(request_id)
...
def log_trace(
    ...
    span.end(
        outputs=response,
        end_time=(start_time_ms + execution_time_ms) * 1000000
