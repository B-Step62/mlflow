    ...
    def to_mlflow_trace(self) -> Trace:
        ...
        for span in self.span_dict.values():
            ...
            if span.parent_id is None:
                ...
                trace_data.request = span._otel_span.attributes.get(SpanAttributeKey.INPUTS)
                trace_data.response = span._otel_span.attributes.get(SpanAttributeKey.OUTPUTS)
    ...
    def start_detached_span(
        ...
        try:
            ...
            if parent_id:
                ...
                context = trace_api.set_span_in_context(parent_span._otel_span)
            else:
                context = None
