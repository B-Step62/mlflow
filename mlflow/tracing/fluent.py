...
from mlflow.tracing.utils import capture_function_input_args, encode_span_id, get_request_id
...
def start_span(
    ...
    **the entire trace will be logged when the root span is ended**.
    ...
    try:
        ...
        mlflow_span = LiveSpan(otel_span, request_id=get_request_id(otel_span), span_type=span_type)
