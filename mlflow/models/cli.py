...
@click.option("--retain-image", "-ri", is_flag=True, default=False, help="Retain image after validation is successful.")
@click.option("--optimized", "-o", is_flag=True, default=False, help="Optimize docker image size.")
def validate_local(
    model_uri,
    input_data,
    header,
