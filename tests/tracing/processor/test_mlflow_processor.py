...
def test_on_start(monkeypatch):
    ...
    processor = MlflowExperimentSpanProcessor(span_exporter=mock.MagicMock(), client=mock_client)
...
def test_on_end():
    ...
    processor = MlflowExperimentSpanProcessor(span_exporter=mock_exporter, client=mock_client)
