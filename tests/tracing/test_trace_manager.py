...
def test_add_spans():
    ...
    exp_id_1 = "test_experiment_1"
    trace_id_1 = "trace_id_1"
    request_id_1 = "request_id_1"
    trace_manager.add_trace(trace_id_1, TraceInfo(request_id_1, exp_id_1, 0))
    ...
    trace_manager.get_or_create_mlflow_span(span_1_1)
    ...
    trace_manager.get_or_create_mlflow_span(span_1_1_1)
    trace_manager.get_or_create_mlflow_span(span_1_1_2)

    assert len(trace_manager._traces[trace_id_1].span_dict) == 3

    # Add a span for another trace under the different experiment
    exp_id_2 = "test_experiment_2"
    trace_id_2 = "trace_id_2"
    request_id_2 = "request_id_2"
    trace_manager.add_trace(trace_id_2, TraceInfo(request_id_2, exp_id_2, 0))
    span_2_1 = _create_test_span(trace_id_2, "span_2_1")
    span_2_1_1 = _create_test_span(trace_id_2, "span_2_1_1", parent_span_id="span_2_1")

    trace_manager.get_or_create_mlflow_span(span_2_1)
    trace_manager.get_or_create_mlflow_span(span_2_1_1)
    ...
    assert trace_manager.pop_trace("request_id_3") is None
...
def test_add_and_pop_span_thread_safety():
    ...
    for trace_id in trace_ids:
        ...
        trace_manager.add_trace(trace_id, TraceInfo(request_id, "test", 0))

    num_threads = 10
    def add_spans(thread_id):
        for trace_id in trace_ids:
            trace_manager.get_or_create_mlflow_span(_create_test_span(trace_id, f"span_{thread_id}"))
...
def test_traces_buffer_expires_after_ttl(monkeypatch):
    ...
    trace_id_1 = "tr-1"
    request_id_1 = "req-1"
    trace_manager.add_trace(trace_id_1, TraceInfo(request_id_1, "test", 0))
...
def test_traces_buffer_max_size_limit(monkeypatch):
    ...
    trace_id_2 = "tr-2"
    request_id_2 = "req-2"
    trace_manager.add_trace(trace_id_2, TraceInfo(request_id_2, "test", 0))
...
def test_get_span_from_id():
    ...
    span_1_1 = _create_test_span(trace_id_1, "span")
    span_1_2 = _create_test_span(trace_id_1, "child_span", parent_span_id=span_1_1.span_id)

    trace_id_2 = "tr-2"
    request_id_2 = "req-2"
    trace_manager.add_trace(trace_id_2, TraceInfo(request_id_2, "test", 0))
    span_2_1 = _create_test_span(trace_id_2, "span")
    span_2_2 = _create_test_span(trace_id_2, "child_span", parent_span_id=span_2_1.span_id)

    # Add a span for a new trace
    trace_manager.get_or_create_mlflow_span(span_1_1)
    trace_manager.get_or_create_mlflow_span(span_1_2)
    trace_manager.get_or_create_mlflow_span(span_2_1)
    trace_manager.get_or_create_mlflow_span(span_2_2)

    assert trace_manager.get_span_from_id(request_id_1, "span")._span == span_1_1
    assert trace_manager.get_span_from_id(request_id_2, "child_span")._span == span_2_2
...
def test_set_trace_tag():
    ...
    span = _create_test_span(trace_id, "span")
    trace_manager.get_or_create_mlflow_span(span)
