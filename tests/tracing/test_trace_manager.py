...
def test_add_spans():
    ...
    trace_id_1 = "tr-1"
    otel_trace_id_1 = 12345
    trace_manager.register_trace(otel_trace_id_1, create_test_trace_info(trace_id_1, "test_1"))

    # Add a span for a new trace
    span_1_1 = _create_test_span(trace_id_1, otel_trace_id_1, span_id=1)
    ...
    span_1_1_1 = _create_test_span(trace_id_1, otel_trace_id_1, span_id=2, parent_id=1)
    span_1_1_2 = _create_test_span(trace_id_1, otel_trace_id_1, span_id=3, parent_id=1)
    ...
    trace_id_2 = "tr-2"
    otel_trace_id_2 = 67890
    trace_manager.register_trace(otel_trace_id_2, create_test_trace_info(trace_id_2, "test_2"))

    span_2_1 = _create_test_span(trace_id_2, otel_trace_id_2, span_id=1)
    span_2_1_1 = _create_test_span(trace_id_2, otel_trace_id_2, span_id=2, parent_id=1)
    ...
    # Pop the trace data
    trace = trace_manager.pop_trace(otel_trace_id_1)
    assert isinstance(trace, Trace)
    assert trace.info.trace_id == trace_id_1
    ...
    trace = trace_manager.pop_trace(otel_trace_id_2)
    assert isinstance(trace, Trace)
    assert trace.info.trace_id == trace_id_2
...
def test_add_and_pop_span_thread_safety():
    ...
    def add_spans(thread_id):
        for trace_id in trace_ids:
            trace_manager.register_span(
                _create_test_span(f"tr-{trace_id}", otel_trace_id=trace_id, span_id=thread_id)
            )
    ...
    for trace_id in trace_ids:
        ...
        assert trace.info.trace_id == f"tr-{trace_id}"
...
def test_traces_buffer_expires_after_ttl(monkeypatch):
    ...
    trace_manager = InMemoryTraceManager.get_instance()
    trace_id_1 = "tr-1"
    trace_manager.register_trace(12345, create_test_trace_info(trace_id_1, "test"))

    span_1_1 = _create_test_span(trace_id_1)
    trace_manager.register_span(span_1_1)
...
def test_traces_buffer_expires_and_log_when_timeout_is_set(monkeypatch):
    ...
    trace_manager = InMemoryTraceManager.get_instance()
    trace_id_1 = "tr-1"
    trace_info = create_test_trace_info(trace_id_1, "test")
    trace_manager.register_trace(12345, trace_info)

    span_1_1 = _create_test_span(trace_id_1)
    trace_manager.register_span(span_1_1)

    assert trace_manager._traces.get(trace_id_1) is not None
    assert len(trace_manager._traces[trace_id_1].span_dict) == 1
...
def test_traces_buffer_max_size_limit(monkeypatch):
    ...
    trace_manager = InMemoryTraceManager.get_instance()
    trace_id_1 = "tr-1"
    trace_manager.register_trace(12345, create_test_trace_info(trace_id_1, "experiment"))
    ...
    trace_id_2 = "tr-2"
    trace_manager.register_trace(67890, create_test_trace_info(trace_id_2, "experiment"))
    span_2_1 = _create_test_span(trace_id_2)
    trace_manager.register_span(span_2_1)
...
def test_get_span_from_id():
    ...
    trace_id_1 = "tr-1"
    trace_manager.register_trace(12345, create_test_trace_info(trace_id_1, "test"))
    span_1_1 = _create_test_span(trace_id_1, otel_trace_id=111, span_id=1)
    span_1_2 = _create_test_span(trace_id_1, otel_trace_id=111, span_id=2, parent_id=1)

    trace_id_2 = "tr-2"
    trace_manager.register_trace(67890, create_test_trace_info(trace_id_2, "test"))
    span_2_1 = _create_test_span(trace_id_2, otel_trace_id=222, span_id=1)
    span_2_2 = _create_test_span(trace_id_2, otel_trace_id=222, span_id=2, parent_id=1)
    ...
    assert trace_manager.get_span_from_id(trace_id_1, span_1_1.span_id) == span_1_1
    assert trace_manager.get_span_from_id(trace_id_2, span_2_2.span_id) == span_2_2
...
def test_get_root_span_id():
    ...
    trace_id_1 = "tr-1"
    trace_manager.register_trace(12345, create_test_trace_info(trace_id_1, "test"))
    span_1_1 = _create_test_span(trace_id_1, span_id=1)
    span_1_2 = _create_test_span(trace_id_1, span_id=2, parent_id=1)

    # Add a span for a new trace
    trace_manager.register_span(span_1_1)
    trace_manager.register_span(span_1_2)

    assert trace_manager.get_root_span_id(trace_id_1) == span_1_1.span_id
...
def _create_test_span(
    ...
    span = LiveSpan(mock_otel_span, trace_id)
    span.set_status("OK")
    return span
