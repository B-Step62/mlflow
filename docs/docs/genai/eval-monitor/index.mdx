...
<table style={{ width: "100%" }}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <pre><code>def predict_fn(question: str) -> str:<br/>    response = client.chat.completions.create(<br/>        model="gpt-4.1-mini",<br/>        messages=\[\{"role": "user", "content": question\}\]<br/>    )<br/>    return response.choices[0].message.content</code></pre>
      </td>
    </tr>
  </tbody>
</table>
