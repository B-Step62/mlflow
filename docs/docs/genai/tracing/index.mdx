...
import RawPixelCanvas from "@site/src/components/RawPixelCanvas";
  ...
  <Tabs>
    <TabItem value="debugging" label="Build & Debug" default>
      ...
      <div className="mintlify-debug-image-wrap">
        ...
        <RawPixelCanvas
          src={useBaseUrl("/images/llms/tracing/genai-trace-debug-mintlify-crop.rgba")}
          width={801}
          height={535}
          className="mintlify-debug-canvas"
          ariaLabel="Trace Debugging"
        />
      </div>
...
<RawPixelCanvas
  src={useBaseUrl("/images/llms/tracing/mintlify-autolog-code-block-crop.rgba")}
  width={801}
  height={102}
  className="mintlify-code-block-canvas"
  ariaLabel="Code example showing mlflow.openai.autolog setup"
/>
