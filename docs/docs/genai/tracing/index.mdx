...
<div className="mlflow-docs-header">
  <div className="mlflow-docs-eyebrow">Overview</div>
  <h1 className="mlflow-docs-title">LLM Tracing and Agent Observability</h1>
...
<TabsWrapper>
  <Tabs>
    <TabItem value="debugging" label="Build & Debug" default>
      ...
      <ImageBox src="/images/llms/tracing/genai-trace-debug-crop.png" alt="Trace Debugging" />
