...
:::info What is Novita AI?
<u>[Novita AI](https://novita.ai/)</u> is a unified cloud for AI models, agents, and GPU workloads. It offers simple APIs, global performance, and cost-efficient infrastructure for developers building modern AI applications.
:::

:::tip Why use MLflow with Novita AI?

MLflow provides comprehensive observability for your applications using Novita AI models. Traces are also seamlessly integrated with MLflow's prompt management, evaluation, and monitoring capabilities.
