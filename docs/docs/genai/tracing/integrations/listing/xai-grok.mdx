...
:::info What is Grok?
<u>[Grok](https://x.ai/)</u> is xAI’s large language model designed to provide real-time, up-to-date reasoning by leveraging data from the X platform. Built for speed, humor, and strong general intelligence, it powers conversational agents and advanced AI applications across the xAI ecosystem.
:::

:::tip Why use MLflow with Grok?

MLflow provides comprehensive observability for your applications using Grok models. Traces are also seamlessly integrated with MLflow's prompt management, evaluation, and monitoring capabilities.
