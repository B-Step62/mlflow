...
:::info What is BytePlus?
<u>[BytePlus](https://www.byteplus.com/)</u> is ByteDance's cloud AI platform that offers hosted large language and multimodal models via API endpoints.
:::

:::tip Why use MLflow with BytePlus?

MLflow provides comprehensive observability for your applications using BytePlus LLMs. Traces are also seamlessly integrated with MLflow's prompt management, evaluation, and monitoring capabilities.
