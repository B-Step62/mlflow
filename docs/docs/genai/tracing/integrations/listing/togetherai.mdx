...
[MLflow Tracing](../../) provides automatic tracing capability for Together AI through the OpenAI SDK integration. Since Together AI offers an OpenAI-compatible API format, you can use `mlflow.openai.autolog()` to trace interactions with Together AI models.

<ImageBox src="/images/llms/tracing/openai-function-calling.png" alt="Tracing via autolog" />

:::info What is Together AI?
<u>[Together AI](https://www.together.ai/)</u> hosts leading open-source and proprietary models with an OpenAI-compatible interface and generous throughput.
:::

:::tip Why use MLflow with Together AI?

MLflow provides comprehensive observability for your applications using Together AI LLMs. Traces are also seamlessly integrated with MLflow's prompt management, evaluation, and monitoring capabilities.
...
<StepHeader number={3} title="Enable tracing and call Together AI" />
...
<ImageBox src="/images/llms/tracing/basic-openai-trace.png" alt="Together AI Tracing" />
...
<ImageBox src="/images/llms/tracing/openai-trace-with-manual-span.png" alt="Together AI Tracing with Manual Tracing" />
