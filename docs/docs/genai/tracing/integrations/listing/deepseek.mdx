...
:::info What is DeepSeek?
<u>[DeepSeek](https://www.deepseek.com/)</u> offers high-performance chat and reasoning models with an OpenAI-compatible API surface.
:::

:::tip Why use MLflow with DeepSeek?
MLflow gives you full observability—traces, token usage, latency, and metadata—while integrating with prompt management, evaluation, and user feedback.
:::
