...
[MLflow Tracing](../../) provides automatic tracing capability for Cohere models through the OpenAI SDK integration. Since Cohere offers an OpenAI-compatible API format, you can use `mlflow.openai.autolog()` to trace interactions with Cohere models.

:::info What is Cohere?
<u>[Cohere](https://cohere.com/)</u> provides enterprise-grade language models (Command, Embed, and Rerank) for text and chat applications.
:::

:::tip Why use MLflow with Cohere?

MLflow provides comprehensive observability for your applications using Cohere LLMs. Traces are also seamlessly integrated with MLflow's prompt management, evaluation, and monitoring capabilities.
...
<StepHeader number={3} title="Enable tracing and call Cohere" />
...
<ImageBox src="/images/llms/tracing/basic-openai-trace.png" alt="Cohere Tracing" />
...
<ImageBox src="/images/llms/tracing/openai-trace-with-manual-span.png" alt="Cohere Tracing with Manual Tracing" />
