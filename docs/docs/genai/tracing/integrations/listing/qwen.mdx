...
[MLflow Tracing](../../) provides automatic tracing capability for Qwen models through the DashScope platform's inference endpoints. Since DashScope offers an OpenAI-compatible API for Qwen models, you can use `mlflow.openai.autolog()` to trace interactions with Qwen models.

<ImageBox src="/images/llms/tracing/openai-function-calling.png" alt="Tracing via autolog" />

:::info What is Qwen?

<u>[Qwen](https://qwen.ai/)</u> is a family of large language models developed by Alibaba, designed for general-purpose reasoning, coding, and multilingual understanding. The models come in sizes ranging from lightweight to frontier-scale and power chatbots, agents, and enterprise AI applications.

_Looking for tracing locally hosted Qwen models? Check out the integration with local inference tools like <u>[Ollama](/genai/tracing/integrations/listing/ollama)</u>_.
:::

:::tip Why use MLflow with Qwen?

MLflow provides comprehensive observability for your applications using Qwen models. Traces are also seamlessly integrated with MLflow's prompt management, evaluation, and monitoring capabilities.
...
<StepHeader number={3} title="Enable tracing and call Qwen" />
...
<Tabs>
  ...
  <TabItem value="typescript" label="JS / TS">
    ...
    // Wrap the OpenAI client and point to Qwen endpoint
...
<ImageBox src="/images/llms/tracing/basic-openai-trace.png" alt="Qwen Tracing" />
...
MLflow supports tracing for streaming and async Qwen APIs. Visit the [OpenAI Tracing documentation](../openai) for example code snippets for tracing streaming and async calls through OpenAI SDK.
...
<Tabs>
  ...
  <TabItem value="typescript" label="JS / TS">
    ...
    // Create a traced function that wraps the Qwen call
...
<ImageBox src="/images/llms/tracing/openai-trace-with-manual-span.png" alt="Qwen Tracing with Manual Tracing" />
