...
For `stream` and `astream`, a trace always captures the full input and output state regardless of `stream_mode`, due to a [known limitation](https://github.com/langchain-ai/langgraph/issues/3705) in LangGraph.
