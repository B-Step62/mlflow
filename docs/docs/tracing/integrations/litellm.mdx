...
MLflow supports automatic tracing for the following LiteLLM APIs:

|Chat Completion|Embeddings|Function Calling|Structured Output|Streaming|Async|Image|Audio|
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
|✅|✅|✅|✅|✅|✅|-|-|
