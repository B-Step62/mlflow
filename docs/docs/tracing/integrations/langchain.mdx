...
MLflow LangChain integration is not only about tracing. MLflow offers full tracking experience for LangChain, including model tracking, prompt management, and evaluation. Please checkout the **[MLflow LangChain Flavor](/llms/langchain)** to learn more!
...
|`invoke`|`batch`|`stream`|`ainvoke`|`abatch`|`astream`|`astream_events`|
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
|✅|✅|✅|✅|✅|✅|✅ (*1)|

(*1) `astream_events` support is available since MLflow 2.21.0.

Following deprecated LangChain APIs are also supported:
