...
const TRACING_INTEGRATIONS: TracingIntegration[] = [
  ...
  },
  {
    ...
    name: 'CometAPI',
    logoPath: '/images/logos/mlflow-logo.svg',
    link: '/genai/tracing/integrations/listing/cometapi',
    category: 'Model Providers',
  },
  {
    id: 'databricks',
  ...
  },
  {
    id: 'huggingface',
    name: 'Hugging Face',
    logoPath: '/images/logos/huggingface-logo.svg',
    link: '/genai/tracing/integrations/listing/huggingface',
    category: 'Model Providers',
  },
  {
    id: 'mistral',
  ...
  },
  {
    id: 'xai-grok',
    name: 'xAI / Grok',
    logoPath: '/images/logos/x-logo-black.png',
